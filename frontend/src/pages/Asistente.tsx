...
// Los cuatro se probaron contra la API en vivo y devuelven una respuesta con
// su fuente. Los tres que habia antes --«¿Que es XSS?», «¿Que es un indice?»
// y «¿Para que sirve Docker?»-- daban «sin informacion» los tres: el
// sintetizador exige dos fragmentos de la misma fuente y con preguntas tan
// cortas no los encuentra.
const EJEMPLOS = [
  "¿Qué es una aplicación móvil?",   // 0,89
  "¿Qué es un servidor web?",        // 0,80
  "¿Qué es una contraseña segura?",  // 0,79
  "¿Qué es SQL?",                    // 0,72
];
